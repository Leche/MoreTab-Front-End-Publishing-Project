...
find v2 -name "*.html" -exec sed -i '' 's|assets/ds.css"|assets/ds.css?v=14"|g; s|assets/ds.js"|assets/ds.js?v=14"|g; s|../assets/ds.css"|../assets/ds.css?v=14"|g; s|../assets/ds.js"|../assets/ds.js?v=14"|g' {} + && \
git add v2 && \
git commit -m "v2: page title letter-spacing normal, GNB nav left-aligned next to brand" && \
git push
```
